...
class OrderItemSerializer(serializers.ModelSerializer):
    ...
    # ⚠️ source НЕ НУЖЕН — имя поля совпадает с именем атрибута модели.
    # DRF 3.17+ выбрасывает AssertionError: "It is redundant to specify
    # source='variant_id' on field 'IntegerField' ... because it is the
    # same as the field name." → просто НЕ указываем source.
