...
class OrderService:
    ...
    def create_from_cart(
        ...
        *,
        ...
        # save() генерирует order_number через default=generate_order_number.
        # Но мы используем _order_number_seq → нужен кастомный вызов.
        # Проще всего: установить order_number вручную.
